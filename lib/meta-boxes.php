...
function cmb_sample_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes['download_metabox'] = array(
		'id'         => 'download_metabox',
		'title'      => __( 'Project download', 'cmb' ),
	...
	$meta_boxes['about_metabox'] = array(
		...
		'fields'     => array(
			array(
				'name'    => __( 'Logos', 'cmb' ),
				'desc'    => __( 'show on about page', 'cmb' ),
				'id'      => $prefix . 'about_logos',
				'type'    => 'wysiwyg',
				'options' => array( 'textarea_rows' => 5, ),
			),
			array(
				'name'    => __( 'Homepage excerpt', 'cmb' ),
				'desc'    => __( 'show on the home page', 'cmb' ),
				'id'      => $prefix . 'about_home',
				'type'    => 'wysiwyg',
				'options' => array( 'textarea_rows' => 5, ),
			),
			array(
				'name'    => __( 'Homepage title', 'cmb' ),
				'desc'    => __( '(only for MA programme)', 'cmb' ),
	...
	$meta_boxes['shop_metabox'] = array(
		'id'         => 'download_metabox',
		'title'      => __( 'Shop item details', 'cmb' ),
		...
		'fields'     => array(
  		array(
			...
			array(
				'name' => __( 'Paypal buy button', 'cmb' ),
				'desc' => __( 'if this item is available to be sold direct thru paypal', 'cmb' ),
				'id'   => $prefix . 'paypal',
				'type' => 'checkbox',
			),
			array(
				'name' => __( 'Amazon buy link', 'cmb' ),
				'desc' => __( '...', 'cmb' ),
				'id'   => $prefix . 'amazon',
				'type' => 'text_url',
